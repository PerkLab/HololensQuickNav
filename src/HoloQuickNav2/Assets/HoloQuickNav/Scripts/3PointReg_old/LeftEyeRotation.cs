...
public class LeftEyeRotation : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        RightMarker = selectedObject.transform.Find("SubFrame/RightMarker").transform.position;
        NoseMarker = selectedObject.transform.Find("SubFrame/NoseMarker").transform.position;
