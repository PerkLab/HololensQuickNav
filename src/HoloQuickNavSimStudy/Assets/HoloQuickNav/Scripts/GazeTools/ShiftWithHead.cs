...
public class ShiftWithHead : MonoBehaviour {
    ...
    public void RightLeft()
    {
        ...
        GameObject.Find("ShiftWithHead").transform.Find("MoveRightArrow").gameObject.SetActive(true);
        GameObject.Find("ShiftWithHead").transform.Find("MoveLeftArrow").gameObject.SetActive(true);
        GameObject.Find("ShiftWithHead").transform.Find("MoveUpArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveDownArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveForwardArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveBackArrow").gameObject.SetActive(false);
    ...
    public void UpDown()
    {
        lastDistance = Vector3.Distance(cam.transform.position, selectedObject.transform.position);
        //adjust visibility of arrows
        GameObject.Find("ShiftWithHead").transform.Find("MoveRightArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveLeftArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveUpArrow").gameObject.SetActive(true);
        GameObject.Find("ShiftWithHead").transform.Find("MoveDownArrow").gameObject.SetActive(true);
        GameObject.Find("ShiftWithHead").transform.Find("MoveForwardArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveBackArrow").gameObject.SetActive(false);
        //select direction of movement
        rightLeft = false;
    ...
    public void ForwardBack()
    {
        ...
        GameObject.Find("ShiftWithHead").transform.Find("MoveUpArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveDownArrow").gameObject.SetActive(false);
        GameObject.Find("ShiftWithHead").transform.Find("MoveForwardArrow").gameObject.SetActive(true);
        GameObject.Find("ShiftWithHead").transform.Find("MoveBackArrow").gameObject.SetActive(true);
